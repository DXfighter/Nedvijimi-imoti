    ...
    internal class Connection
    {
        ...
        public void Update(Imoti p)
        {
            try
            {
                ...
                command.Parameters.AddWithValue("tip", p.tip);
                command.Parameters.AddWithValue("adres", p.adres);
                command.Parameters.AddWithValue("sobstvenik", p.sobstvenik);
                command.Parameters.AddWithValue("cena", p.cena);
                command.Parameters.AddWithValue("plosht", p.plosht);
                command.Parameters.AddWithValue("stai", p.stai);
                command.Parameters.AddWithValue("etaji", p.etaji);
                command.Parameters.AddWithValue("etaj", p.etaj);
                command.Parameters.AddWithValue("ploshtzadendvor", p.ploshtzadendvor);
                command.Parameters.AddWithValue("ImotID", p.ImotID);
